...
public class MenuViewController {
	 ...
	 * @param categories Categories to be added for the category list menu.
	 */
	 ...
	 * @return Ingredients from the local foodItem object.
	 */
	 ...
	 * @param foodItem Fooditem of which ingredients are retrieved.
	 * @return Ingredients from the database foodItem object.
	 */
